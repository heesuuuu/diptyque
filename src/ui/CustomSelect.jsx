...
const CustomSelect = ({ options, defaultValue, onChange }) => {
  ...
  return (
    <div className="relative w-64" ref={dropdownRef}>
      {/* 선택 버튼 */}
      <button
        className="flex items-center justify-between px-4 py-3 text-left bg-white border border-gray-300   hover:bg-gray-50 focus:outline-none"
...
const Component = () => {
  ...
  return (
    <CustomSelect options={options} defaultValue={options[0]} onChange={(option) => console.log('Selected:', option)} />
  );
};
